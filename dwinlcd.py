...
class DWIN_LCD:
		...
		if (encoder_diffState == self.ENCODER_DIFF_CW):
			...
			if (self.select_prepare.now == 0):  # Back
				...
				self.lcd.Draw_FloatValue(
					...
					3, 1, 216, self.MBASE(1), self.pd.current_position.x * self.MINUNITMULT, True
				)
				self.lcd.Draw_FloatValue(
					True, True, 0, self.lcd.font8x16, self.lcd.Color_White, self.lcd.Color_Bg_Black,
					3, 1, 216, self.MBASE(2), self.pd.current_position.y * self.MINUNITMULT, True
				)
				self.lcd.Draw_FloatValue(
					True, True, 0, self.lcd.font8x16, self.lcd.Color_White, self.lcd.Color_Bg_Black,
					3, 1, 216, self.MBASE(3), self.pd.current_position.z * self.MINUNITMULT, True
				)
			...
			if (self.pd.HMI_flag.ETempTooLow_flag):
				if (encoder_diffState == self.ENCODER_DIFF_ENTER):
					...
					self.lcd.Draw_FloatValue(
						...
						self.pd.HMI_ValueStruct.Move_X_scale, True
					)
					self.lcd.Draw_FloatValue(
						True, True, 0, self.lcd.font8x16, self.lcd.Color_White, self.lcd.Color_Bg_Black,
						3, 1, 216, self.MBASE(2),
						self.pd.HMI_ValueStruct.Move_Y_scale, True
					)
					self.lcd.Draw_FloatValue(
						True, True, 0, self.lcd.font8x16, self.lcd.Color_White, self.lcd.Color_Bg_Black,
						3, 1, 216, self.MBASE(3),
						self.pd.HMI_ValueStruct.Move_Z_scale, True
					)
					self.lcd.Draw_Signed_Float(
	...
	def HMI_Move_X(self):
		...
		self.lcd.Draw_FloatValue(
			True, True, 0, self.lcd.font8x16, self.lcd.Color_White, self.lcd.Select_Color,
			3, 1, 216, self.MBASE(1), self.pd.HMI_ValueStruct.Move_X_scale, True)
		self.lcd.UpdateLCD()
	...
	def HMI_Move_Y(self):
		...
		self.lcd.Draw_FloatValue(
			True, True, 0, self.lcd.font8x16, self.lcd.Color_White, self.lcd.Select_Color,
			3, 1, 216, self.MBASE(2), self.pd.HMI_ValueStruct.Move_Y_scale, True)
		self.lcd.UpdateLCD()
	...
	def HMI_Move_Z(self):
		...
		self.lcd.Draw_FloatValue(
			True, True, 0, self.lcd.font8x16, self.lcd.Color_White, self.lcd.Select_Color,
			3, 1, 216, self.MBASE(3), self.pd.HMI_ValueStruct.Move_Z_scale, True)
		self.lcd.UpdateLCD()
	...
	def Draw_Tune_Menu(self):
		...
		if self.pd.HAS_FAN:
		 	...
		 	self.lcd.Draw_IntValue(
		 		...
		 		self.pd.thermalManager['fan_speed'][0], False
		 	)
		if self.pd.HAS_ZOFFSET_ITEM:
